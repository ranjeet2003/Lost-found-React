...
export default ({
  ...
  description = "We are open source, independent developers. Your liitle help can make us motivate to develop such applications that helps society.",
  primaryButtonText = ` Donate Us `,
  primaryButtonUrl = "/",
