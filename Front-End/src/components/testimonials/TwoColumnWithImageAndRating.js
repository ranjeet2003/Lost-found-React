...
export default ({
  ...
  heading = "Experience of people who joined our portal.",
  description = "If this platform really helped you, or you got you lost docs or this platform motivates you to make people helps, please write us a testimonial.",
  textOnLeft = false,
  testimonials = [
    {
      stars: 5,
